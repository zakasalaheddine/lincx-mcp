/**
 * tests/contract/buildApp.ts
 *
 * The ONE place the contract suite knows how the HTTP surface is assembled.
 *
 * This exists so that http.test.ts can stay byte-identical across the stack
 ...
 *
 * It mirrors src/index.ts's assembly for every route EXCEPT /mcp and /dev/*.
